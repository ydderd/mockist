...
declare module "vitest" {
  interface Assertion<T = any> extends MockistVitestMatchers<T> {}
  interface AsymmetricMatchersContaining extends MockistVitestMatchers<any> {}
}

interface MockistVitestMatchers<R> {
...
/** Optional default harness when using `expect().toHaveCalledTool` without passing harness. */
